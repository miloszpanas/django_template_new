...
all:   done.python done.dirs done.gecko done.chrome done.node done.preproc

clean:
	rm -rf done.*

distclean: clean
	rm -rf Python-* node-* dist geckodriver* chromedriver* clojupyter-master
